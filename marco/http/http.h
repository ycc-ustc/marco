#ifndef __MARCO_HTTP_H__
#define __MARCO_HTTP_H__
...
#undef XX
    ...
    public:
        ...
        const MapType& getHeader() {
            return m_headers;
        }
        const MapType& getParams() {
            return m_params;
        }
        const MapType& getCookies() {
            return m_cookies;
        }
        ...
        void setHeaders(const MapType& val) {
            m_headers = val;
        }
        void setParams(const MapType& val) {
            m_params = val;
        }
        void setCookies(const MapType& val) {
            m_cookies = val;
        }
